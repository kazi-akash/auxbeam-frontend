    ...
    <section className="relative py-12 sm:py-16 md:py-24 min-h-[500px] sm:min-h-[577px] overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-white text-[14px] sm:text-[16px] font-[400] max-w-3xl mx-auto leading-relaxed px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-[1312px] mx-auto">
          ...
          <div className="bg-[#FEF9C3] rounded-[8px] w-full max-w-[313px] h-auto min-h-[220px] sm:min-h-[234px] pt-5 sm:pt-[21px] px-4 sm:px-[16px] pb-4 mx-auto">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#FDDE35] rounded-[8px] flex items-center justify-center mb-6 sm:mb-8">
              <Shield className="w-[20px] h-[20px] sm:w-[24px] sm:h-[24px] text-[#12100E]" />
            </div>
            <h3 className="text-[18px] sm:text-[20px] font-[600] text-[#000000] mb-3 sm:mb-[16px]">
          ...
          <div className="bg-[#FEF9C3] rounded-[8px] w-full max-w-[313px] h-auto min-h-[220px] sm:min-h-[234px] pt-5 sm:pt-[21px] px-4 sm:px-[16px] pb-4 mx-auto">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#FDDE35] rounded-[8px] flex items-center justify-center mb-6 sm:mb-8">
              <Zap className="w-[20px] h-[20px] sm:w-[24px] sm:h-[24px] text-[#12100E]" />
            </div>
            <h3 className="text-[18px] sm:text-[20px] font-[600] text-[#000000] mb-3 sm:mb-[16px]">
              Performance Driven
            </h3>
          ...
          <div className="bg-[#FEF9C3] rounded-[8px] w-full max-w-[313px] h-auto min-h-[220px] sm:min-h-[234px] pt-5 sm:pt-[21px] px-4 sm:px-[16px] pb-4 mx-auto">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#FDDE35] rounded-[8px] flex items-center justify-center mb-6 sm:mb-8">
              <Wrench className="w-[20px] h-[20px] sm:w-[24px] sm:h-[24px] text-[#12100E]" />
            </div>
            <h3 className="text-[18px] sm:text-[20px] font-[600] text-[#000000] mb-3 sm:mb-[16px]">
              Expert Installation
            </h3>
          ...
          <div className="bg-[#FEF9C3] rounded-[8px] w-full max-w-[313px] h-auto min-h-[220px] sm:min-h-[234px] pt-5 sm:pt-[21px] px-4 sm:px-[16px] pb-4 mx-auto">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#FDDE35] rounded-[8px] flex items-center justify-center mb-6 sm:mb-8">
              <Headphones className="w-[20px] h-[20px] sm:w-[24px] sm:h-[24px] text-[#12100E]" />
            </div>
            <h3 className="text-[18px] sm:text-[20px] font-[600] text-[#000000] mb-3 sm:mb-[16px]">
              Dedicated Support
            </h3>
