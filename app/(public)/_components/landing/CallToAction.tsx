...
export default function CallToAction() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // Container scales up subtly as it enters
      gsap.fromTo(
        wrapperRef.current,
      ...
      if (children?.length) {
        gsap.fromTo(
          ...
          { opacity: 0, y: 24 },
          {
            ...
            scrollTrigger: { trigger: contentRef.current, start: 'top 86%', toggleActions: 'play none none none' },
          }
        );
      }
    }, sectionRef);
  ...
  return (
    <section ref={sectionRef} className="py-10 md:pb-16 lg:pb-[100px] bg-white">
      <div className="container mx-auto px-4 sm:px-6 md:px-8">
        <div ref={wrapperRef} className="relative h-[400px] sm:h-[440px] md:h-[480px] rounded-[8px] overflow-hidden">
          {/* Background Image */}
          <Image
          ...
          <div className="relative h-full flex items-center">
            <div ref={contentRef} className="max-w-2xl px-6 md:px-8 lg:px-16">
              {/* Heading */}
