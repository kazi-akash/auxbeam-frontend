    ...
    <section className="py-16">
      <div className="container mx-auto">
        ...
        <Link
          ...
          className="relative group overflow-hidden rounded-[8px] h-[630px] block"
        >
          <Image
        ...
        <div className="grid grid-rows-2 gap-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <Link
              ...
              className="relative group overflow-hidden rounded-[8px] h-[315px] sm:h-full block"
            >
              <Image
          ...
          <Link
            ...
            className="relative group overflow-hidden rounded-[8px] h-[303px] block"
          >
            <Image
